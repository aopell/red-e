...
namespace E
{
    ...
    internal class EParser : LRkParser
    {
        ...
        public static void VisitASTNode(ASTNode node, Visitor visitor)
        {
            ...
            {
                case 0x0004:
                    visitor.OnTerminalWhiteSpace(node);
                    break;
                case 0x0005:
                    visitor.OnTerminalSeparator(node);
                    break;
                case 0x0006:
                    visitor.OnTerminalYfinal(node);
                    break;
                case 0x0007:
                    visitor.OnTerminalWithin(node);
                    break;
                case 0x0008:
                    visitor.OnTerminalLike(node);
                    break;
                case 0x0009:
                    visitor.OnTerminalTonight(node);
                    break;
                case 0x000A:
                    visitor.OnTerminalLater(node);
                    break;
                case 0x000B:
                    visitor.OnTerminalMins(node);
                    break;
                case 0x000C:
                    visitor.OnTerminalIsh(node);
                    break;
                case 0x000D:
                    visitor.OnTerminalInsoon(node);
                    break;
                case 0x000E:
                    visitor.OnTerminalInsoonish(node);
                    break;
                case 0x000F:
                    visitor.OnTerminalSoon(node);
                    break;
                case 0x0010:
                    visitor.OnTerminalSoonish(node);
                    break;
                case 0x0011:
                    visitor.OnTerminalAtOrBefore(node);
                    break;
                case 0x0012:
                    visitor.OnTerminalAminute(node);
                    break;
                case 0x0013:
                    visitor.OnTerminalAnhour(node);
                    break;
                case 0x0014:
                    visitor.OnTerminalRange(node);
                    break;
                case 0x0015:
                    visitor.OnTerminalInteger(node);
                    break;
                case 0x0016:
                    visitor.OnTerminalNumber(node);
                    break;
                case 0x0017:
                    visitor.OnTerminalMinute(node);
                    break;
                case 0x0018:
                    visitor.OnTerminalTexttime(node);
                    break;
                case 0x0019:
                    visitor.OnTerminalHour(node);
                    break;
                case 0x001A:
                    visitor.OnTerminalE(node);
                    break;
                case 0x001B:
                    visitor.OnVariableNow(node);
                    break;
                case 0x001C:
                    visitor.OnVariableNn(node);
                    break;
                case 0x001D:
                    visitor.OnVariableNminutes(node);
                    break;
                case 0x001E:
                    visitor.OnVariableNhours(node);
                    break;
                case 0x001F:
                    visitor.OnVariableN(node);
                    break;
                case 0x0020:
                    visitor.OnVariableA(node);
                    break;
                case 0x0021:
                    visitor.OnVariableIn(node);
                    break;
                case 0x0022:
                    visitor.OnVariableSoon(node);
                    break;
                case 0x0023:
                    visitor.OnVariableSoonish(node);
                    break;
                case 0x0024:
                    visitor.OnVariableTime(node);
                    break;
                case 0x0025:
                    visitor.OnVariableAt(node);
                    break;
                case 0x0026:
                    visitor.OnVariablePrompt(node);
                    break;
            }
        }
